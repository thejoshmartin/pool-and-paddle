...
- **Task Tracker** — Asana-style task rows with assignees (JM/KM), due dates, notes, and localStorage persistence
...
pool-and-paddle/
├── src/
│   ├── App.jsx                # Main app (Dashboard, Executive Brief, Podcast Intel, Task Tracker)
